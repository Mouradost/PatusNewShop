...
################################################################################
## Form generated from reading UI file 'CouponSearch.ui'
##
...
"")
        ...
        self.tb_coupon_info = QTextBrowser(Form)
        self.tb_coupon_info.setObjectName(u"tb_coupon_info")

        self.verticalLayout.addWidget(self.tb_coupon_info)
        ...
        self.bb_coupon.setStandardButtons(QDialogButtonBox.Apply|QDialogButtonBox.Cancel)
